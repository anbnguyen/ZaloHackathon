...
public class Recent_Video extends FragmentActivity implements LoadListener, ChangeTopFragmentVideo{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initComponent();
//        GlobalVariables.RecentVideo.add("-OiqrV_YvuI");
        new LoadDataRecent(this, dataList).execute(GlobalVariables.RecentVideo);
    ...
    private void PostVideoURLtoServer(final String videoID) {
        ...
        final AsyncTask asyncLogin = new AsyncTask()
        {
            ...
            protected void onPostExecute(Object o)
            {
                ...
                Toast.makeText(Recent_Video.this, result, Toast.LENGTH_LONG).show();
